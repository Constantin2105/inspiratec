...
const CompanyLogin = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Connexion Entreprise - InspiraTec</title>
        <meta name="description" content="Connectez-vous à votre espace entreprise pour gérer vos missions." />
      </Helmet>
        ...
        >
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            ...
            <Button asChild variant="link" className="p-0 h-auto">
              <Link to="/signup/company" className="font-semibold text-primary">
                Inscrivez-vous
              </Link>
            </Button>
          </p>

...
const DocumentsTab = () => {
  ...
  useEffect(() => {
    if (user) {
        fetchDocuments('received', pagination.received);
        fetchDocuments('sent', pagination.sent);
    }
    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Téléversez un document qui sera transmis à l'équipe d'administration.</CardDescription>
        </CardHeader>
        <CardContent>

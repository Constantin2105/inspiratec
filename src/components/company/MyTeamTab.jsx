                  ...
                  <TableRow key={candidature.id}>
                    <TableCell className="font-medium">
                      <div className="flex items-center gap-2">
                        <AvatarViewer
                          src={candidature.expert_avatar_url}
                          alt={candidature.expert_code}
                          fallback={candidature.expert_code ? candidature.expert_code.substring(0, 2) : 'EX'}
                        />
                        {candidature.expert_code}
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-right">
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => handleViewDossier(candidature.dossier_candidature_url)}
